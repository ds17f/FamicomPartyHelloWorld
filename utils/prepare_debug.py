...
if __name__ == "__main__":
    rom_name = sys.argv[1]
    label_to_nl(f"{rom_name}.labels.txt", f"{rom_name}.nes.ram.nl", 0x0000, 0x7FF)
    label_to_nl(f"{rom_name}.labels.txt", f"{rom_name}.nes.0.nl", 0x8000, 0xBFFF)
    label_to_nl(f"{rom_name}.labels.txt", f"{rom_name}.nes.1.nl", 0xC000, 0xFFFF)